...
<div className='w-full  justify-center Intro  pt-32 px-16 hidden lg:flex'>
...
<div className='w-[30%] m-8 space-y-3  flex-col justify-center  '>
...
<button className='bg-[#DD3D31] w-[90%] rounded-lg text-white h-14  '>Free Download</button>
