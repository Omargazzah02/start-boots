    ...
    <>
      <nav className="flex flex-col bg-white fixed top-0 left-0 w-full z-50">
        <div className="w-full justify-between flex flex-row">
          <div className="flex justify-around items-center w-[50%]">
            ...
            <div className="hidden lg:w-[80%] lg:flex lg:justify-between">
              ...
              <a href="#" className="text-gray-600 no-underline">Ressources</a>
            </div>
          </div>
        ...
        >
          ...
          <a href="#" className="text-gray-600 no-underline p-1">Forms</a>
          <a href="#" className="text-gray-600 no-underline p-1">Ressources</a>
